...
public class ExpoArcgisModule: Module {
  public func definition() -> ModuleDefinition {
    ...
    Function("setAllowUntrustedHosts") { (allow: Bool) in
    ...
    Class(KmlLayerRef.self) {
      ...
      Function("playTour") { (ref: KmlLayerRef) in ref.playTour() }
      Function("pauseTour") { (ref: KmlLayerRef) in ref.pauseTour() }
      Function("resetTour") { (ref: KmlLayerRef) in ref.resetTour() }
    }
    ...
    Class(GeoElementViewshedRef.self) {
      Constructor { (graphic: GraphicRef, props: [String: Any]) -> GeoElementViewshedRef in
        GeoElementViewshedRef(graphic: graphic, props: props)
      }
      Function("applyProps") { (ref: GeoElementViewshedRef, changed: [String: Any]) in
        ref.applyProps(changed)
      }
    }
    ...
    Class(GeoElementLineOfSightRef.self) {
      Constructor { (observer: GraphicRef, target: GraphicRef) -> GeoElementLineOfSightRef in
        GeoElementLineOfSightRef(observer: observer, target: target)
      }
    }
    ...
    View(ExpoArcgisMapView.self) {
      ...
      Prop("imageOverlays") { (view: ExpoArcgisMapView, refs: [ImageOverlayRef]) in
      ...
      Prop("contentInsets") { (view: ExpoArcgisMapView, insets: [String: Any]?) in
        view.setContentInsets(insets)
      }
      Prop("insetsViewpointAdjustment") { (view: ExpoArcgisMapView, value: String?) in
      ...
      Prop("timeExtent") { (view: ExpoArcgisMapView, value: [String: Any]?) in
      ...
      AsyncFunction("identifyPopups") { (view: ExpoArcgisMapView, screenPoint: [String: Any], options: [String: Any]?) in
    ...
    View(ExpoArcgisSceneView.self) {
      ...
      Prop("timeExtent") { (view: ExpoArcgisSceneView, value: [String: Any]?) in
        view.setTimeExtent(value)
      }
